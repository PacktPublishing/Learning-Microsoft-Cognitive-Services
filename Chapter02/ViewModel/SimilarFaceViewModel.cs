...
namespace Chapter2.ViewModel
{
    public class SimilarFaceViewModel : ObservableObject
    {
        ...
        {
            string[] imageDirectories = Directory.GetDirectories("./PersonGroup/");
            string[] images = GetImageFiles(imageDirectories);
        ...
        private string[] GetImageFiles(string[] directories)
        {
